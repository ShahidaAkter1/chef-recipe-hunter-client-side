 ...
 <Pdf targetRef={ref} filename="Blog.pdf">
            ...
            <div ref={ref}>
                <div className='container my-5'>
                    <h2 className='text-danger fw-bold fs-2'>1.Tell us the differences between uncontrolled and controlled components.</h2>
                    ...
                    <h2 className='text-danger fw-bold fs-2'>2. How to validate React props using PropTypes</h2>
                    ...
                    <h2 className='text-danger fw-bold fs-2'>3. Tell us the difference between nodejs and express js.</h2>
                    ...
                    <h2 className='text-danger fw-bold fs-2'>4. What is a custom hook, and why will you create a custom hook?</h2>
